...
func (r *UserRepository) AddPermission(ctx context.Context, permission models.Permission) error {
...
func (r *UserRepository) DeletePermission(ctx context.Context, id int) error {
...
func (r *UserRepository) UpdatePermission(ctx context.Context, permission models.Permission) error {
...
func (r *UserRepository) GetPermissionsByUserID(ctx context.Context, userID int) ([]models.Permission, error) {
